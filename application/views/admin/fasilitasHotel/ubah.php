                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <li><a href="<?=site_url('FasilitasHotel/read')?>">Kembali</a></li>
                        </ol>
                    </div>
                </div>
            </div>
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center">Ubah Data Fasilitas Hotel <?= $detail->nama ?></h3>
                                        </div>
                                        <hr>
                                        <form action="<?=site_url('FasilitasHotel/update/'.$detail->id)?>" method="post" novalidate="novalidate" enctype="multipart/form-data">
                                            <div class="form-group">
                                                <img src="<?= base_url('images/fasilitas_hotel/'.$detail->gambar)?>" width="450px" height="280px">
                                            </div>
                                            <input type="hidden" name="id" value="<?=$detail->id?>">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input id="cc-name" name="" type="text" class="form-control" value="<?= $detail->keterangan ?>">
                                                </div>
                                                <div class="row">
                                                    <br>
                                                    <div class="col-6">
