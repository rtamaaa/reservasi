                            ...
                            <div class="card-body">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <?php 
                                            $i = 1;
                                            foreach ($result as $flshtl ) {
                                                 $tampil = $this->db->get_where('transaksi',array('nama' => $flshtl->nama))->row(); 
                                         ?>
                                        <tr>
                                            <td><?= $i++ ?></td>
                                            <td><img src="<?= base_url('images/fasilitas_hotel/'.$flshtl->gambar)?>" width="150px" height="100px"></td>
                                            <td><?=$flshtl->nama ?></td>
                                            <td><?=$flshtl->keterangan ?></td>
                                            <td>
                                                <a class="btn btn-success" href="<?=site_url('FasilitasHotel/edit/'.$flshtl->id)?>">Edit</a>
                                                <a class="btn btn-danger" href="<?=site_url('FasilitasHotel/delete/'.$flshtl->id)?>" onclick="return confirm('Are U Sure?')">Delete</a>
                                            </td>
                                            <!-- <td>
                                                <?php 
                                                    if($cat->sold_049==1){ 
    ...
    <div id="contact-modal" class="modal fade" role="dialog" style="margin-top: 200px">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form action="<?=site_url('FasilitasHotel/do_upload')?>" method="post" enctype="multipart/form-data" novalidate="novalidate">
                    <div id="pay-invoice">
                            <div class="card-body">
                                <hr>
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="cc-name" name="keterangan" type="text" class="form-control" >
                                </div>
                                ><div class="row">
                                    <div class="col-6">
